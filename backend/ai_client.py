...
def generate_outreach_emails(persona: str, goal: str, stage: str, tone: str,
    ...
    system = (
        ...
        "BELANGRIJK: verzin geen aannames over WIE de klanten van de "
        "ontvanger zijn (bijv. 'je levert aan cafés en restaurants') - een "
        "horeca-groothandel kan aan heel verschillende typen klanten "
        "leveren en dat is vooraf niet bekend. Noem zo'n specifiek "
        "klanttype alleen als dat al letterlijk in de meegegeven "
        "pijnpunten/waardeproposities staat; gebruik anders gewoon het "
        "neutrale woord 'klanten'. "
